        ...
        <form action="{{ route('profile.update') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" id="phone_number" name="no_hp" value="{{ old('phone_number', $user->no_hp) }}"
                        class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-gray-700 focus:outline-none focus:border-yellow-500">
                </div>
            ...
            <div class="flex justify-end space-x-4 pt-4">
                ...
                <button type="submit"
                    class="btn-yellow py-2 px-6 rounded-full font-medium shadow-md hover:shadow-lg transition">
                    Simpan Perubahan
                </button>
            </div>
        </form>
