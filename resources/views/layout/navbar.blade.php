    ...
    <div class="sm:flex items-center gap-7 text-xl text-gray-700 hidden">
        ...
        @auth
            ...
            <div class="relative group">
                ...
                @if ($authUser && $authUser->gambar != null)
                    <img class="rounded-full w-10 cursor-pointer"
                        src="{{ asset('img/upload/' . $authUser->gambar) }}" alt="">
                @else
                    <img class="rounded-full w-10 cursor-pointer" src="{{ asset('img/default_pp.png') }}"
                        alt="">
                @endif
